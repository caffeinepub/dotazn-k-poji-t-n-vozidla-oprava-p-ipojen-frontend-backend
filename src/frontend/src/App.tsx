      ...
      return (
        ...
        >
          <div className="min-h-screen flex flex-col bg-gradient-to-br from-black via-red-950 to-red-900 relative overflow-x-hidden">
            ...
            />
            <div
              className="absolute top-0 left-0 w-96 h-96 bg-red-600/10 rounded-full pointer-events-none"
              style={{ filter: "blur(100px)" }}
            />
            <div
              className="absolute bottom-0 right-0 w-96 h-96 bg-red-800/10 rounded-full pointer-events-none"
              style={{ filter: "blur(100px)" }}
            />
    ...
    return (
      ...
      >
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-black via-red-950 to-red-900 relative overflow-x-hidden">
          ...
          />
          <div
            className="absolute top-1/2 left-1/2 w-[600px] h-[600px] bg-red-700/5 rounded-full pointer-events-none"
            style={{
              filter: "blur(100px)",
